...
class MainMenu
  ...
  def create_station
    ...
    station = gets.chomp
    if @stations.find {|station| station.name == station}
      puts "Станция с названием #{st} уже существует. Введите другое название:"
      create_station
    else
  ...
  def create_train
    ...
    puts "Присвойте номер создаваемому поезду:"
    number = gets.chomp
